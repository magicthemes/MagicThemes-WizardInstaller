...
<head>
	...
	<title>MagicThemes Wizard</title>
...
<div id="header">
<h1><a href="http://magicthemes.com" target="_new">MagicThemes Installation Wizard</a></h1>
</div>
<div id="stepbar">
	<ol>
	<li <?php echo $this->_activeStep == 'index' ? 'class="active"' : '' ?>>
	<span class="number">1</span>
	<?php echo ABIText::_('STEP_INDEX') ?>
	</li>
	<li <?php echo $this->_activeStep == 'db' ? 'class="active"' : '' ?>>
	<span class="number">2</span>
	<?php echo ABIText::_('STEP_DB') ?>
	</li>
	<li <?php echo $this->_activeStep == 'setup' ? 'class="active"' : '' ?>>
	<span class="number">3</span>
	<?php echo ABIText::_('STEP_INFO') ?>
	</li>
	<li	<?php echo $this->_activeStep == 'finish' ? 'class="active"' : '' ?>>
	<span class="number">4</span>
	<?php echo ABIText::_('STEP_FINISH') ?></li>
	</ol>
</div>
<div id="container">
...
<div id="footer">
	<p>
	<a id="magicthemes" href="http://magicthemes.com" target="_new">A Creation of MagicThemes</a>
	</p>
	<p>Packed using a slightly modified version of <a href="http://www.akeebabackup.com/" target="_new">AkeebaBackup</a>
	</p>
</div>
